      ...
      >
        ...
        >
          <div className="card-body bg-white/40 shadow-2xl items-center justify-center py-10">
            ...
            <p className="flex-none text-slate-700">Unleash your inner virtuoso and join our captivating violin class! Learn to draw out mesmerizing melodies from the strings of this elegant instrument, as our experienced instructors guide you through the art of playing the violin with precision, passion, and poise.</p>
        ...
        >
          <div className="card-body bg-white/40 shadow-2xl items-center justify-center py-10">
            ...
            <p className="flex-none text-slate-700">Dive into the rich and soulful world of the cello, a true instrument of emotional expression. In our cello class, you'll learn to harness its deep and resonant tones, under the guidance of our expert teachers. Discover the art of bowing, plucking, and creating captivating melodies that will tug at heartstrings.</p>
