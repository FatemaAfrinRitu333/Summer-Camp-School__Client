  ...
  return (
    ...
    >
      <footer className="footer p-10 bg-gradient-to-r from-base-100/80 to-warning/80 text-base-content">
        ...
        <div className="">
          <span className="footer-title opacity-100 text-xl text-green-800">--------</span>
          <Link tp='/' className="link link-hover">Home</Link>
          <Link tp='/instructors' className="link link-hover">Instructors</Link>
          <Link tp='/classes' className="link link-hover">Classes</Link>
          <Link tp='/dashboard' className="link link-hover">Dashboard</Link>
        </div>
        <div>
          ...
          <p><b>Contact No:</b> 01923473482</p>
          <p><b>Email:</b> chorus@camp.com</p>
          <p><b>Address:</b> A street, B house, XYZ</p>
        </div>
      </footer>
